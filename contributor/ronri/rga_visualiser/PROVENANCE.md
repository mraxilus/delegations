...
top; each front-end centres its own text.
  ...
  **The horizon line's label stands above the leftmost point of either band**, its left-edge
  crossing, which glides; not the highest point, which on a level horizon hopped between the two
  side crossings, within a pixel in height: 46 swaps of 1,070 px in 97 frames at elevation 0.2.
  **The sky's frame's label stands inside the bottom-left corner**, on the frame's left edge
