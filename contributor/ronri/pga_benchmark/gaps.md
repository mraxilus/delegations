...
- **D01, over.** Dense products spend every Cayley-table term where typed forms spend few. Evidence:
  84 gaps; widest cga5d/partner_round_point spends 1004 multiplies against 10. Closes when no typed
  gap spends more multiplies than its reference.
- **D02, over.** Library calls run slower than typed forms beyond the band. Evidence: 155 gaps;
  worst cga5d/partner_sphere at 278.5 ns against 2.1 ns. Closes when no gap's library median exceeds
  1.25 times its reference's.
- **D03, over.** Operators zero-fill their full-width result before writing it. Evidence: 174 of 188
...
- **D05, over.** Error-flag checks survive into release builds. Evidence: 70 of 188 library
  functions; most cga5d `⊛(Multivector)` with 273. Closes when no library function branches on
...
4 dimensions, rigid metric, 128-byte multivector. Counts: inspect taken 2026-09-22 on linux amd64, 4
cores; nim `27763495bcfe265507ca98aedc1c7064bf1e0e4d`; pga
`9f9019b26b46490f79f383eee693b1abc84a4f63`; flags `-d:release`. Times: bench taken 2026-09-22 on
...
5 dimensions, conformal metric, 256-byte multivector. Counts: inspect taken 2026-09-22 on linux
...
3 dimensions, rigid metric, 64-byte multivector. Counts: inspect taken 2026-09-22 on linux amd64, 4
cores; nim `27763495bcfe265507ca98aedc1c7064bf1e0e4d`; pga
`9f9019b26b46490f79f383eee693b1abc84a4f63`; flags `-d:release`. Times: bench taken 2026-09-22 on
linux amd64, 4 cores, 40 rounds over 1024 objects, allocation gauge live.
...
4 dimensions, conformal metric, 128-byte multivector. Counts: inspect taken 2026-09-22 on linux
amd64, 4 cores; nim `27763495bcfe265507ca98aedc1c7064bf1e0e4d`; pga
`9f9019b26b46490f79f383eee693b1abc84a4f63`; flags `-d:release`. Times: bench taken 2026-09-22 on
linux amd64, 4 cores, 40 rounds over 1024 objects, allocation gauge live.
