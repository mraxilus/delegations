...
domain-neutral test project that exercises every mechanism the audit enforces. Each project
carries README.md, PROVENANCE.md, GLOSSARY.md, `<project>.nimble` and `tests/`.
